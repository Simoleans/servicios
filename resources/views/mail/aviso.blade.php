                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" src='{{ asset(logoApp()) }}' alt="{{ nameApp() }}" width="125" style="max-width:125px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            Su servicio : <strong>[ {{ $subscripcion->servicio->nombre }} ]</strong> esta a punto de vencer.<br>
<br>
Si desea renovar pulse <strong><a href="{{ route('servicio.renovar.show',$subscripcion->servicio->slug) }}">AQUI!</a></strong><br>
<br>
Link : {{ route('servicio.renovar.show',$subscripcion->servicio->slug) }}
                        </td>
                    </tr>
                </tbody></table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <em>Copyright ©  {{ nameApp() }}  Todos los derechos reservados.</em><br>
&nbsp;
                        </td>
                    </tr>
                </tbody></table>
