                            ...
                            @foreach($productos as $p)
                                ...
                                <article class="inline overflow-hidden rounded-md shadow-xl mt-4 sm:mt-5 md:mt-4">
                                    ...
                                    <div class="flex items-center  flex-col justify-between leading-tight p-2 md:p-4">
                                        ...
                                        <a href="{{ route('my-store',$p->producto->slug) }}" class="mt-3 btn-buy-services  transform hover:-translate-y-1 motion-reduce:transition-none hover:scale-110 motion-reduce:transform-none hover:bg-blue-700">
