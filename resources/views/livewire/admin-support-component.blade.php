                ...
                @endif
                    <div class="flex justify-between p-4 bg-gray-400">
                        ...
                        <div>
                            ...
                            @endif
                            @if($closeButton)
                                <button wire:click="closeMessage" title="Mensajes Cerrados" class="bg-blue-500 text-grey-darkest font-bold py-2 px-2 rounded inline-flex items-center">
                    ...
                    <div class="overflow-auto p-2 shadow-inner bg-white dark:bg-gray-800" style="height: 25rem;">
