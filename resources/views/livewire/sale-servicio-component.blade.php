                            ...
                            <article class="inline overflow-hidden rounded-md shadow-md mt-4 sm:mt-5 md:mt-4 border-2 border-gray-600">
                                ...
                                <div class="flex flex-col">
                                    @if( request()->routeIs('servicio.renovar.show') )
                                        <a href="{{ route('payment_renovar_mercadopago_index',['slug' => $s->servicio->slug,'ciclo' => $s->id]) }}" class="btn-renovar-services  transform hover:-translate-y-1 motion-reduce:transition-none hover:scale-110 motion-reduce:transform-none hover:bg-blue-700">
                                    ...
                                    @else
                                        <a href="{{ route('payment_mercadopago_index',['slug' => $s->servicio->slug,'ciclo' => $s->id]) }}" class="btn-buy-services  transform hover:-translate-y-1 motion-reduce:transition-none hover:scale-110 motion-reduce:transform-none hover:bg-blue-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block mr-1" viewBox="0 0 20 20" fill="currentColor">
