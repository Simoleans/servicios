<div x-show="show == true">
    <x-jet-modal maxWidth="3xl">
        <input type="hidden"   x-ref="pID" wire:model="productoID">
        ...
        <div class="grid grid-cols-2 gap-4 grid-rows-1 px-4 py-4 mt-2">
            <div>
              ...
              <x-jet-input wire:model.defer="porcentaje" type="number" x-bind:readonly="disabledField == true" placeholder="Nombre" x-model="porcentaje" required/>
