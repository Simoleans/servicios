    ...
    @foreach($productos as $p)
        ...
        <article class="inline overflow-hidden rounded-md shadow-xl mt-4 sm:mt-5 md:mt-4">
            ...
            <div class="flex items-center  flex-col justify-between leading-tight p-2 md:p-4">
                ...
                <p class="text-grey-darker text-3xl mt-5 mb-4">
                    ${{ number_format($p->precio_normal,2,',','.') }}
                </p>
                <button class="btn-buy-services  transform hover:-translate-y-1 motion-reduce:transition-none hover:scale-110 motion-reduce:transform-none hover:bg-red-700">
...
@else
    ...
    No Hay Resultados para la busqueda {{$searchProducto}}
    </div>
@endif