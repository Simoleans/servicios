<div class="py-5" x-data="main()">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 border-2 border-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                ...
                @csrf
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                      <label class="block uppercase tracking-wide text-gray-400 dark:text-white text-xs font-bold mb-2" for="grid-first-name">
                        Email
                      </label>
